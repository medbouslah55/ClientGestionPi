  ...
  return (
    <Suspense fallback={<div />}>
      <Switch>
        ...
        <Route exact path={`${process.env.PUBLIC_URL}/project-tuteur`} component={projects}></Route>
        {/*Pre-built Pages*/}
        ...
        <Route exact path={`${process.env.PUBLIC_URL}/theme`} component={Theme}></Route>
...
{/* ************************************** Etudiant ************************************************* */}
        {/* <Route exact path={`${process.env.PUBLIC_URL}/list-etudiant`} component={ListEtudiant}></Route> */}
        <Route exact path={`${process.env.PUBLIC_URL}/Students`} component={TransListBasic}></Route>
        <Route //Context Api added
          exact
          path={`${process.env.PUBLIC_URL}/Students_Coo`}
          render={() => (
            <UserContextProvider>
              <Students_Coo />
            </UserContextProvider>
